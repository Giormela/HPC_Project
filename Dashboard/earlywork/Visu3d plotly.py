...
fig.update_layout(
    ...
    title='',
    # Adjusting the margins to ensure the legend is not cut off
    margin=dict(r=200)  # Increase right margin
)



fig.write_image(f"figs/fig_iter_n{iteration}.png", height = 1000, width = 1100,  scale = 2)
